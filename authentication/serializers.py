...
from rest_framework_simplejwt.serializers import api_settings as jwt_setting
...
class InfluencerSerializer(serializers.ModelSerializer):
    class Meta:
        model = Influencer
        fields = ["id", "first_name", "last_name", "email", "password", "username", "birthday", "mobile",
...
class InfluencerDetailSerializer(serializers.ModelSerializer):
    class Meta:
        model = Influencer
        fields = ["id", "first_name", "last_name", "email", "username", "birthday", "mobile",
                  "instagram_handle", "tiktok_handle", "facebook_handle"]
...
class TokenObtainPairSerializer(TokenObtainPairSerializer):
    ...
    def validate(self, attrs):
        ...
        if jwt_setting.UPDATE_LAST_LOGIN:
